...
def main():
    ...
    train_labels1 = torch.FloatTensor(traindf[ycols[0]].apply(lambda x:eval(x)))
    val_labels1 = torch.FloatTensor(validdf[ycols[0]].apply(lambda x:eval(x)))
    train_labels2 = torch.FloatTensor(traindf[ycols[1]].apply(lambda x:eval(x)))
    val_labels2 = torch.FloatTensor(validdf[ycols[1]].apply(lambda x:eval(x)))
