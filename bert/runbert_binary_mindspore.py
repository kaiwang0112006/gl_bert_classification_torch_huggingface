...
def getOptions():
    ...
    parser.add_argument('--lr', dest='lr', type=int, help="learning rate", default=2e-5)
...
def main():
    ...
    # start training
    trainer.train()
    model.save_pretrained("bestbertmodel")
    tokenizer.save_pretrained("bestbertmodel")
